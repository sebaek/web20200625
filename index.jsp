...
<form action="index2.jsp" method="post">
	...
	<select name="mySel" id="">
		...
		<option value="b">Dolore?</option>
		<option value="c">Sequi?</option>
		<option value="d">Ipsa?</option>
		<option value="e">Mollitia.</option>
	</select>
	<br />
	...
	<input type="radio" name="myFruit" value="melon"/>melon <br />
	
	<input type="checkbox" name="myHome" value="daum" />daum <br />
	<input type="checkbox" name="myHome" value="naver" />naver <br />
	<input type="checkbox" name="myHome" value="google" />google <br />
